...
import { ConsiderList } from "@/components/changes/consider-list";
...
export function ChangesConsiderPageClient({ params }: Props) {
  ...
  return (
    <div className="flex flex-col gap-6" data-testid="changes-consider-page">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-2xl font-black uppercase">Considering</h1>
      </div>
      <DeckTabs deckId={deckId} />
      <ConsiderList deckId={deckId} />
    </div>
  );
}
